...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_euclid')) {
        Object.defineProperty(Module['ready'], '_euclid', { configurable: true, get: function() { abort('You are getting _euclid on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_euclid', { configurable: true, set: function() { abort('You are setting _euclid on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _euclid = Module["_euclid"] = createExportWrapper("euclid");
